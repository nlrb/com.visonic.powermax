	...
	*/
	...
	getZoneStatus(zone) {
		...
		if (this.zone !== undefined && this.zone[id] !== undefined) {
			this.events.emit(id, 'trip', this.zone[id].trip)
			this.events.emit(id, 'battery', this.zone[id].battery)
			this.events.emit(id, 'tamper', this.zone[id].tamper)
			this.events.emit(id, 'bypass', this.zone[id].bypass)
			this.events.emit(id, 'tripAlarm', this.zone[id].tripAlarm)
			this.events.emit(id, 'tamperAlarm', this.zone[id].tamperAlarm)
		} else {
