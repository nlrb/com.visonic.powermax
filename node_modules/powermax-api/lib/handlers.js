...
var self = module.exports = {
	...
	handlePanel: function(state) {
		...
		for (var i = 1; i<= msgCnt; i++) {
			...
			updateStatus(state, 'system', 'alarmType', { alarmType: alarmStatus, nr: eventType, txt: pm.panelAlarmText[locale][alarmStatus] });
			updateStatus(state, 'system', 'troubleType', { troubleType: troubleStatus, nr: eventType, txt: pm.panelTroubleText[locale][troubleStatus] });
